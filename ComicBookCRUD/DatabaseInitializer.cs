...
namespace ComicBookGalleryModel
{
        ...
        : DropCreateDatabaseIfModelChanges<Context>
    {
        protected override void Seed(Context context)
        {
            ...
            var americanHouse = new PublishingHouse()
            {
                Name = "New York Times",
                Country = "USA",
            };
            
            var britishHouse = new PublishingHouse()
            {
                Name = "BBC",
                Country = "UK",
            };

            var romanianHouse = new PublishingHouse()
            {
                Name = "Adevarul",
                Country = "RO",
            };
            ...
            var comicBook1 = new ComicBook()
            {
                ...
                AverageRating = 7.1m,
                // PublishingHouse = americanHouse,
                // PublishingHouse = "USA",
                
            };
            comicBook1.AddArtist(artistStanLee, roleScript);
            comicBook1.AddArtist(artistSteveDitko, rolePencils);
            comicBook1.AddPublishingHouse(americanHouse);
            comicBook1.AddPublishingHouse(romanianHouse);
            ...
            comicBook2.AddPublishingHouse(americanHouse);
            comicBook2.AddPublishingHouse(britishHouse);
            ...
            comicBook3.AddPublishingHouse(americanHouse);
            comicBook3.AddPublishingHouse(britishHouse);
            ...
            comicBook4.AddPublishingHouse(americanHouse);
            comicBook4.AddPublishingHouse(britishHouse);
            ...
            comicBook5.AddPublishingHouse(americanHouse);
            comicBook5.AddPublishingHouse(britishHouse);
            ...
            comicBook6.AddPublishingHouse(americanHouse);
            comicBook6.AddPublishingHouse(britishHouse);
            ...
            comicBook7.AddPublishingHouse(americanHouse);
            comicBook7.AddPublishingHouse(britishHouse);
            ...
            comicBook8.AddPublishingHouse(americanHouse);
            comicBook8.AddPublishingHouse(britishHouse);
